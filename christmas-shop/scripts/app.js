...
class Card {
    ...
    get createCard() {
        ...
        const snowStar = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20.7 24">
              <path transform="translate(-0.7)" fill="currentColor" 
              d="M17.3,14.8l-.8-.5,2.2-.6-.4-1.4-3.6,1-1.7-1v-.8l1.7-1,3.6,1,
              ...
              l1.7,1,1,3.6,1.4-.4-.6-2.2.8.5L18.6,19l2.8-1-.6-3Z"/></svg>`
